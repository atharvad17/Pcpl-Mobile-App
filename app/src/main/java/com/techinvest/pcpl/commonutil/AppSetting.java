...
public class AppSetting extends AppSettingMain implements AppConstants {
    ...
    public static String KEY_URL="http://111.125.232.137:8085/PCPLWebServices/Service1.asmx";
    ...
    private static String KEY_CHECKED_VALUE = "checkValue";
	...
	*/
    ...
    public static String getKeyCheckedValue() {
        return getString(KEY_CHECKED_VALUE, null);
    }

    public static void setKeyCheckedValue(String keyCheckedValue) {
        setString(KEY_CHECKED_VALUE, keyCheckedValue);
    }
}
